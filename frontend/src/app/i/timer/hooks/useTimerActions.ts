...
import { useUpdateRound } from "../rounds/useUpdateRound";
import type { IPomodoroRoundResponse } from "@/types/pomodoro.types";

type TypeUseTimerAction = ITimerState & {
    rounds: IPomodoroRoundResponse[] | undefined
}
export  function useTimerActions({activeRound, setIsRunning, secondsLeft,rounds,setActiveRound}:TypeUseTimerAction) {
